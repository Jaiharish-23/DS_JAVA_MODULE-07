...
If index i is not visited, start from index i.
Keep following nums[k] until a visited element is encountered.
Count the number of elements visited.
Update maxLength if the current count is greater.
Output the value of maxLength.
...
<img width="540" height="107" alt="image" src="https://github.com/user-attachments/assets/ac771b83-f412-48d8-8d60-a68e3a2b5ff3" />
