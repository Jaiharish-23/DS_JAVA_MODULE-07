...
Create the NestedIterator class to flatten the nested list using a stack.

3. Implement the following methods:

hasNext() → Checks whether more integers are available.
next() → Returns the next integer in sequence.
In the main program:

4. Create nested lists of integers.
5. Create a NestedIterator object.
6. Use the iterator to traverse and print all integers sequentially.
7. Stop the program.  
...
<img width="737" height="108" alt="image" src="https://github.com/user-attachments/assets/a76ef5a9-f20c-46bc-8f1a-9a05b16d81b8" />
